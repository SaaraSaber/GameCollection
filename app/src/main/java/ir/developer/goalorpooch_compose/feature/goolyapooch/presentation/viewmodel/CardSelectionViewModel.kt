...
class CardSelectionViewModel @Inject constructor(
    ...
    private fun loadData() {
        viewModelScope.launch {
            ...
            val desc =
                "$teamNameStr بازی کارت های خود را انتخاب کند. شما باید $maxCards کارت از کارت های زیر را انتخاب کنید."
    ...
    fun handleIntent(intent: CardSelectionIntent) {
        when (intent) {
            ...
            is CardSelectionIntent.OnConfirmClicked -> sendEffect(
                CardSelectionEffect.NavigateToDisplay(
